//#region node_modules/.nitro/vite/services/ssr/assets/blogPosts-CWHN7DfV.js
var blogCategories = [
	"Digital Marketing",
	"SEO",
	"Web Development",
...
var blogPosts = [
	{
		...
		excerpt: "Most business websites are structured like brochures. Here is how to restructure yours around the decision a buyer actually makes.",
	...
	},
	{
		...
		excerpt: "Publishing more articles rarely fixes a technical problem. Work through these foundations first.",
		category: "SEO",
		date: "2026-08-04",
	...
	},
	{
		...
		excerpt: "Creative is the biggest lever in Meta advertising. Testing it needs structure, not guesswork.",
	...
	},
	{
		...
		excerpt: "Advertising without conversion tracking is spending without feedback. Here is the minimum setup.",
	...
	},
	{
		...
		excerpt: "For local businesses, search visibility often comes down to a handful of unglamorous fundamentals.",
		category: "SEO",
		date: "2026-06-23",
		readingTime: "5 min read",
		body: [
	...
	},
	{
		...
		excerpt: "Branding is often treated as decoration. It is closer to a shortcut for trust.",
		category: "Branding",
		date: "2026-06-09",
...
//#endregion
export { blogPosts as n, getBlogPost as r, blogCategories as t };
