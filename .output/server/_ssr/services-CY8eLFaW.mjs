import { c as Server, d as PenTool, g as Megaphone, i as Target, k as ChartColumn, l as Search, p as MonitorSmartphone, x as Globe } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/services-CY8eLFaW.js
var services = [
	{
		...
		description: "Fast, responsive and strategically designed websites that turn visitors into enquiries.",
	...
	},
	{
		...
		description: "Build sustainable search visibility and reach customers when they are actively looking for your business.",
		icon: Search,
		includes: [
			"Technical SEO",
			"On-Page SEO",
	...
	},
	{
		...
		description: "Strategic Facebook and Instagram advertising built around targeting, creative testing and measurable conversions.",
		icon: Megaphone,
		includes: [
			"Lead Generation",
			"Audience Targeting",
	...
	},
	{
		...
		description: "Reach high-intent customers through strategic Google Search and performance campaigns.",
		icon: Target,
		includes: [
			"Search Ads",
			"Keyword Strategy",
	...
	},
	{
		...
		description: "Strategic content and social media management designed to build visibility, trust and engagement.",
		icon: Globe,
		includes: [
			"Instagram",
			"Facebook",
	...
	},
	{
		...
		description: "Identity and creative systems that make your business look as credible as it is.",
		icon: PenTool,
		includes: [
			"Logo Design",
			"Brand Identity",
	...
	},
	{
		...
		description: "Domains, hosting, email and maintenance handled so your digital presence stays online and secure.",
		icon: Server,
		includes: [
			"Domain Setup",
			"Web Hosting",
	...
	},
	{
		...
		description: "Tracking and reporting that connect marketing activity to enquiries, calls and sales.",
		icon: ChartColumn,
		includes: [
			"Google Analytics",
			"Search Console",
...
var getService = (slug) => services.find((s) => s.slug === slug);
//#endregion
export { services as n, getService as t };
