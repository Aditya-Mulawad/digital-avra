//#region node_modules/.nitro/vite/services/ssr/assets/site-CtMJfd1y.js
/**
...
var whatsappHref = () => `https://wa.me/${site.whatsappNumber.replace(/\D/g, "")}?text=${encodeURIComponent(site.whatsappMessage)}`;
//#endregion
export { whatsappHref as n, site as t };
